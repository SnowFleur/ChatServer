...
const int CHAT_ROOM_COUNT     = 6;  

enum CHAT_MODE { CM_NORMAL = 1, CM_MEGAPHONE };
...
struct cs_whisperMessage_packet:public PacketHeader{
  ...
  cs_whisperMessage_packet():PacketHeader(sizeof(cs_whisperMessage_packet),PACKET_TYPE::CS_WHISER_MESSAGE){}
};
